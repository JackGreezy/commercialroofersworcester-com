...
html body header,html body #header,html body #site-header,html body #project-header,html body [id="header"],html body .site-header,html body .main-header,html body .elementor-location-header,html body [class*="Header_header"],html body [class*="site-header"]{{background:linear-gradient(135deg,var(--rh-primary),var(--rh-secondary))!important;color:#fff!important;}}
html body header a,html body #header a,html body #site-header a,html body #project-header a,html body .site-header a,html body .main-header a,html body .elementor-location-header a,html body [class*="Header_header"] a{{color:#fff!important;}}
